...
let shuffledOriginalCards = shuffle(originalCards, 2);
	...
	for (let i=0; i<originalCards.length; i++) {
		...
		setTimeout(() => { 
			if (!stopAudio) {
				...
				responsiveVoice.speak(originalCards[i][0], "French Female", {rate: 1.0});
				// $(".sentenceBinder.french").append(`<div class='sentenceContainer'><span class='frenchSentence sentenceText'>${originalCards[i][0]}</span></div>`);
			}
		...
		setTimeout(() => { 
			if (!stopAudio) {
				responsiveVoice.speak(originalCards[i][1], "US English Female", {rate: 1.0}); 
				$(".sentenceBinder.french").append(`<div class='sentenceContainer'><span class='frenchSentence sentenceText'>${originalCards[i][0]}</span></div>`);
				$(".sentenceBinder.english").append(`<div class='sentenceContainer'><span class='englishSentence sentenceText'>${originalCards[i][1]}</span></div>`);
			}
		}, i*4000 + 2000);
	}
